...
public class afUtill {
    ...
    /**
     * Converte o automato finito nao-deterministico (AFND) passado
     * como parametro em um automato finito deterministico (AFD)
     * @param af eh um automato finito
     * @return [verificar necessidade de retorno]
     */
    ...
    /**
     * Converte o automato finito passado como parametro
     * em sua representacao na forma de gramatica
     * @param af eh um automato finito
     * @return [verificar necessidade de retorno]
     */
    public void converteAF2GR(AutomatoFinito af){
